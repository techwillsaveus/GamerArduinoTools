...
public class Animator implements Tool,AnimatorListener,ComponentListener,AncestorListener {
	
	private static Editor editor;
	private AnimatorApp app;
	...
	public String getMenuTitle() {
		return "DIY Gamer Animation Generator";
	}

	public void init(Editor editor) {
		Animator.editor = editor;
	}
	private void setupSketch(){
		...
		PImage bg = app.loadImage("Gamer_animator_background.png");
	...
	public void componentHidden(ComponentEvent e) {
         ...
         if (value == JOptionPane.OK_OPTION) {
            ...
            if(name != null) {
	  		    StringSelection stringSelection = new StringSelection (app.getCode(name));
